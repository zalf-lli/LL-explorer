...
//
// `outline` is the canonical brand-palette colour assigned to each LL and
// is intended for site-wide identity reuse (map outlines, badges, accents).
...
export const LL_OUTLINE_FALLBACK = '#eb5b25'

export function getLLOutlineColor(slug) {
  return LL_DISPLAY[slug]?.outline ?? LL_OUTLINE_FALLBACK
}
